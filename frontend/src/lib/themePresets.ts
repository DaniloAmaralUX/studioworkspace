// Presets de tema extraidos do tweakcn (https://tweakcn.com) — Apache-2.0.
// Somente tokens de cor + radius; fontes/sombras omitidas (local-only, sem Google Fonts).
export type ThemeVars = Record<string, string>
export type ThemePreset = { name: string; label: string; light: ThemeVars; dark: ThemeVars }
